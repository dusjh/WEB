...
<%-- EL(Expression Language): 표현 언어
	1. 표현식을 대신해서 사용: ${ }
		<%=데이터 %>  ====> ${데이터}: 데이터 안에는 상수, 계산식...가능
	2. 사용할 데이터가 반드시 scope 안에 존재해야 함.
	...
	3. 같은 이름이 다른 scope상에 존재하는 경우, 접근 우선순위가 적용됨.
		...
		(단, scope 지정 없으면, pageContext -----> application 순으로 찾는다.
...
--%>
	...
	<%--===================2. ============================= --%>
	<h2>EL에서 사용하려면 scope에 속성 정의 후 사용</h2>
	...
	<%--===================3. ============================ --%>
	<h2>동일한 이름의 속성명이 여러 scope상에 존재할 때</h2>
<%
